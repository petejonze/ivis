function myVideoCaptureDemo(fullscreen, fullsize, roi, depth, deviceId, cameraname)
% On windows 7 make sure that libgstwinks.dll is removed (e.g., from
% C:\Program Files (x86)\OSSBuild\GStreamer\v0.10.7\lib\gstreamer-0.10\)
%
...
for repcount=1:1
    ...
    while (GetSecs - t) < 600 
        ...
        [tex pts nrdropped,img]=Screen('GetCapturedImage', win, grabber, 1); %#ok<NASGU>
