...
% load myCalib_kite_20130129T152441;
...
freq = .4;         % Frequency of sine grating (cycles per pixel)
...
%         KbWait([], 3); % Wait for key stroke.
    ...
    while 1
        ...
        t = [];
        vbl = 0;
        while first(InH.getInput() ~= InH.INPT_SPACE.code)
            tic
